...
export const AgencyStats = lazy(() => import('../pages/agencies/AgencyStats'));
...
export const OverdueBillingEventHistories = lazy(() => import('../pages/billing-event-histories/OverdueBillingEventHistories'));
export const UpcomingBillingEventHistories = lazy(() => import('../pages/billing-event-histories/UpcomingBillingEventHistories'));
export const BillingEventHistoryStats = lazy(() => import('../pages/billing-event-histories/BillingEventHistoryStats'));
export const GenerateTransactions = lazy(() => import('../pages/billing-event-histories/GenerateTransactions'));
...
export const OverduePaymentSchedules = lazy(() => import('../pages/payment-schedules/OverduePaymentSchedules'));
export const UpcomingPaymentSchedules = lazy(() => import('../pages/payment-schedules/UpcomingPaymentSchedules'));
export const PaymentScheduleStats = lazy(() => import('../pages/payment-schedules/PaymentScheduleStats'));
export const GeneratePaymentTransactions = lazy(() => import('../pages/payment-schedules/GeneratePaymentTransactions'));
...
export const TransactionReports = lazy(() => import('../pages/billing-transactions/TransactionReports'));
...
export const OfferLetterPreview = lazy(() => import('../pages/offer-letters/OfferLetterPreview'));